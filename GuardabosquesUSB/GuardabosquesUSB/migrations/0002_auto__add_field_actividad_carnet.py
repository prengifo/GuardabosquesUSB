...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actividad.carnet'
        db.add_column(u'GuardabosquesUSB_actividad', 'carnet',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actividad.carnet'
        db.delete_column(u'GuardabosquesUSB_actividad', 'carnet')


    models = {
        u'GuardabosquesUSB.actividad': {
            'Meta': {'object_name': 'Actividad'},
            'carnet': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '8'}),
    ...
    complete_apps = ['GuardabosquesUSB']