...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actividad.hola'
        db.add_column(u'GuardabosquesUSB_actividad', 'hola',
                      self.gf('django.db.models.fields.CharField')(default='h', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actividad.hola'
        db.delete_column(u'GuardabosquesUSB_actividad', 'hola')
    ...
    models = {
        u'GuardabosquesUSB.actividad': {
            ...
            'hola': ('django.db.models.fields.CharField', [], {'default': "'h'", 'max_length': '2'}),
