...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actividad.validado'
        db.add_column(u'GuardabosquesUSB_actividad', 'validado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actividad.validado'
        db.delete_column(u'GuardabosquesUSB_actividad', 'validado')
