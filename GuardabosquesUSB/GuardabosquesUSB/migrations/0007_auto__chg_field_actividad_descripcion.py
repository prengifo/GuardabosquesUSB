...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Actividad.descripcion'
        db.alter_column(u'GuardabosquesUSB_actividad', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Actividad.descripcion'
        db.alter_column(u'GuardabosquesUSB_actividad', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=100))
