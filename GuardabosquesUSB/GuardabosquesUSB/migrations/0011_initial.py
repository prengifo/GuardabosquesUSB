...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'GuardabosquesUSB_actividad', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 19, 0, 0))),
        ))
    ...
    models = {
        u'GuardabosquesUSB.actividad': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
